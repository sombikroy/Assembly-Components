sap.ui.define([
    ...
    return PropertyEditor.extend( "sb.custom.plugins.assemblycomponent.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("sb.custom.plugins.assemblycomponent.i18n.builder");
			this.setPluginResourceBundleName("sb.custom.plugins.assemblycomponent.i18n.i18n");
		},
